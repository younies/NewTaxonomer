...
building_all = subprocess.Popen(['jellyfish', 'count' , '-m' , str(kmer) , '-s' , '10000M' , '-C' , '-o' , all_database_name ] + names, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
...
name_of_fasta_all = path_to_the_program + name_of_genomes_database + '/all.fa'
