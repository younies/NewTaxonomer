...
int main(int argc, const char * argv[]) {
    ...
    if(argc < 5)
    {
        cout << "Usage: name_of_program <full path to the kmer fasta file without .fa > <the name of the fasta kmer> <file length> <kmer length>" << endl;
        return 1;
    }
    ...
    ifstream input_file(file_directory + file_name  + ".fa");
    ...
    ofstream output_file(file_directory + file_name + ".yrj" , ios::binary);
